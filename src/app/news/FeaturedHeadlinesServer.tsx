...
type FeaturedHeadlinesServerProps = {
  page?: number;
  limit?: number;
  queryKey?: string;
};

export async function FeaturedHeadlinesServer({
  page = 1,
  limit = 6,
  queryKey = "featuredNewsPage",
}: FeaturedHeadlinesServerProps = {}) {
  let items: Item[] = [];
  let totalPages = 1;
  try {
    const res = await fetch(
      `${API_PUBLIC}/trendingNews?page=${page}&limit=${limit}`,
      {
        ...
        >
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">
              Top stories and breaking news from the casino industry.
            </Typography>
          </Box>

          <Box
            component="a"
            href={`${SITE_URL}/news#featured`}
          ...
          >
            ...
            >
              View All Headlines <ArrowForward sx={{ fontSize: 18 }} />
            </Typography>
          </Box>
        </Box>
        ...
        >
          {items.length ? (
            ...
            <Typography
              ...
              sx={{ textAlign: "center" }}
            >
              No featured headlines found right now.
            </Typography>
          )}
        </Box>
