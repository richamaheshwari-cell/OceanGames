    ...
    >
      <Box sx={{ maxWidth: 1280, mx: "auto" }}>
        <Box sx={{ textAlign: "center", mb: 4 }}>
          ...
          >
            Explore thousands of exciting casino games from top providers
            worldwide
          </Typography>
        </Box>
          ...
          >
            {items.map((game) => {
              const resolvedImg = normalizeImageUrl(
                game.featureImg ?? game.image ?? null,
              );
                ...
                >
                  ...
                  >
                    <Link
                      ...
                      className="gamesection-slug-link "
                    >
                      <Box
                        sx={{
                          position: "relative",
                    ...
                    >
                      <Link
                        href={`/games/${game.slug}`}
                        className="gamesection-line-177"
                      >
                        <Typography
                          component="h3"
                          variant="h3"
                      ...
                      >
                        {Array.isArray(game.gameDetails) && game.gameDetails[0]
                          ? game.gameDetails[0]
                          : "Explore this game"}
                      </Typography>
                      {playHref ? (
        ...
        <Box sx={{ display: "flex", justifyContent: "center", mt: 4 }}>
          <Link href="/games" className="common-text-decoration">
            <Button
              variant="contained"
              sx={{
                bgcolor: "grey.900",
